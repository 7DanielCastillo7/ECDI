...
# Puntos críticos para y' = y^2 - y^3
puntos_criticos = [0, 1]
nombres_puntos = ['0', '1']
...
intervalos = [
    ...
    (0, 1, 'arriba'),      # 0 < y < 1: y' > 0 (sube)
    (1, 2.2, 'abajo')      # y > 1: y' < 0 (baja)
]
...
plt.plot([0, 0], [-1.2, 2.4], color='navy', linewidth=1.5, zorder=1)
...
plt.text(0, 2.55, r'$eje\ y$', fontsize=13, ha='center', va='bottom', color='navy', fontstyle='italic')
...
# Guardar y mostrar
plt.tight_layout()
plt.savefig("diagrama_b.png", dpi=300, bbox_inches='tight')
plt.show()

print("¡Diagrama de fase del inciso b generado con éxito!")