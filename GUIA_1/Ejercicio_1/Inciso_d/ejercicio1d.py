...
# 1. Ecuación despejada: y' = (6*x - 3*x*y) / (x^2 + 1)
def f(x, y):
...
# Formato visual
plt.title(r"Inciso d) Campo de pendientes para $(x^2 + 1)y' + 3xy = 6x$")
plt.xlabel("x")
plt.ylabel("y")
plt.xlim([-4, 4])
plt.ylim([-4, 4])
...
# Guardar la imagen
plt.savefig("inciso_d.png", dpi=300)
print("¡Gráfica guardada exitosamente como inciso_d.png!")