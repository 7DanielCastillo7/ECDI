...
# 1. Definición de la EDO para el inciso f: y' = x - y
def f(x, y):
    return x - y
...
# Formato visual
plt.title(r"Inciso f) Campo de pendientes para $y' = x - y$")
plt.xlabel("x")
plt.ylabel("y")
plt.xlim([-4, 4])
plt.ylim([-4, 4])
...
# Guardar la imagen
plt.savefig("inciso_f.png", dpi=300)
print("¡Gráfica guardada exitosamente como inciso_f.png!")