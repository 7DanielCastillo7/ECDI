...
# 1. Definición de la EDO para el inciso e: y' = x * e^y
def f(x, y):
    return x * np.exp(y)
...
for y0_val in np.linspace(-3, -0.5, 6):
...
# --- SOLUCIÓN PARTICULAR PVI: Elegida y(0) = -1 ---
x0, y0 = 0, -1
...
# Formato visual
plt.title(r"Inciso e) Campo de pendientes para $y' = x e^y$")
plt.xlabel("x")
plt.ylabel("y")
plt.xlim([-4, 4])
plt.ylim([-4, 4])
...
# Guardar la imagen
plt.savefig("inciso_e.png", dpi=300)
print("¡Gráfica guardada exitosamente como inciso_e.png!")